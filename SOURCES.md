...
| `agentic-coding-heuristics` | engineering | 13 | research-copy-only |
...
| `architecture-hard-parts` | engineering | 7 | research-copy-only |
...
| `bootstrap` | security | 8 | research-copy-only |
...
| `debugging-9-rules` | engineering | 8 | research-copy-only |
...
| `designing-data-intensive-applications` | engineering | 41 | research-copy-only |
...
| `dictionary-of-color-combinations` | design-aesthetics | 1 | research-copy-only |
...
| `graph-classification-and-clustering` | graph-theory | 1 | research-copy-only |
| `graph-engineering-agent-roadmap` | graph-theory | 1 | research-copy-only |
| `graph-partitioning-and-clustering` | graph-theory | 3 | research-copy-only |
...
| `product-deploy-agents-fields` | accessibility, business-marketing, design-aesthetics, engineering | 16 | cc-by-4.0 |
| `programmers-brain` | engineering | 6 | research-copy-only |
| `refactoring-fowler-beck` | engineering | 10 | research-copy-only |
| `refactoring-typescript` | engineering | 6 | research-copy-only |
| `refactoring-ui` | engineering | 8 | research-copy-only |
| `release-it` | engineering | 22 | research-copy-only |
...
| `spectral-clustering-and-biclustering` | graph-theory | 4 | research-copy-only |
| `state-machines-loops-to-graphs` | graph-theory | 4 | research-copy-only |
...
| `why-programs-fail` | engineering | 6 | research-copy-only |
...
_101 sources. Generated by the research corpus; do not edit._
