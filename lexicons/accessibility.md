...
|---|---|---|
| <a name="src-accessibility-report-generation"></a>`accessibility-report-generation` | Swearngin, Amanda; Wu, Jason; Zhang, Xiaoyi; et al. *Towards Automated Accessibility Report Generation for Mobile Apps*. Apple / CMU | 3 |
...
| <a name="src-atag20"></a>`atag20` | W3C. *Authoring Tool Accessibility Guidelines (ATAG) 2.0*. W3C Recommendation, 24 Sept. 2015, www.w3.org/TR/ATAG20/ | 6 |
...
| <a name="src-screen-parsing"></a>`screen-parsing` | Wu, Jason; Zhang, Xiaoyi; Nichols, Jeffrey; Bigham, Jeffrey P. *Screen Parsing: Towards Reverse Engineering of UI Models from Screenshots*. UIST '21. Apple / CMU | 2 |
