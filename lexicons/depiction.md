...
| ATTRIB-08<a name="attrib-08"></a> | Prose about violence, oppression, or enslavement uses an agentless passive, a mutual-event noun, or an event noun that carries no actor ("a clash", "an incident", "were killed") | **Active voice keeps the agent**: an oppressive act described in agentless form -> when the actor is known or record-supported, make that actor the grammatical subject rather than dissolving them into a passive, a symmetry noun, or an actorless event noun; when the record does not support naming who acted, state the gap rather than invent an agent -> agentless grammar relocates responsibility out of the sentence while every individual word stays defensible ↔ [[ATTRIB-02]](depiction.md#attrib-02) ↔ [[BOUND-03]](depiction.md#bound-03) | Does the sentence name who acted, mark the gap, or hide a record-supported agent in a passive, a "clash", or an "incident" frame? | S·d | [anti-racist-description-resources](../SOURCES.md#src-anti-racist-description-resources) |
| ATTRIB-09<a name="attrib-09"></a> | A person held in bondage is described or indexed under the name of the person who enslaved them, because that is how the record was filed, or uses *slave* as the person-noun for people held in bondage in the describer's voice | **Enslaved person's name is the entry**: a name by which an enslaved or formerly enslaved person identified is recoverable -> make it the primary entry, even when only a first name survives, and keep enslaver names as supplemental identifying data; prefer *enslaved*/*captive* and *enslaver* as the describing voice's person-nouns; quoted creator labels stay under [[ATTRIB-05]](depiction.md#attrib-05) -> filing a person under their enslaver reproduces the record-keeping economy that treated them as property, and keyword search already reaches enslaver names held elsewhere in the description ↔ [[ATTRIB-05]](depiction.md#attrib-05) | Is the retrieval key this person's own name, or their enslaver's? | S·d | [anti-racist-description-resources](../SOURCES.md#src-anti-racist-description-resources) |
