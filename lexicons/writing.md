...
Sources: [tropes.fyi](https://tropes.fyi) (Ossama Ben Larbi) and
[Wikipedia:Signs of AI writing](https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing).
The governing caveat is [WRIT-43]: these are triggers for scrutiny, not proof. A
single tell means little; a cluster means edit.
