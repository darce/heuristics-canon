...
- **Boring releases vs loud launches**: [GTM-08]/[GTM-13] stunts ↔ eng [[RLSE-07]](engineering.md) (phased rollout, stop criteria). The marketing moment can be theatrical, but the rollout percentage is set by the monitoring plan, never by the stunt calendar.
