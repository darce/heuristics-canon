...
| GTM-09<a name="gtm-09"></a> | drafting any outbound message | **Research × personalization × relevance**: all three or silence | What is uniquely true about *them* in the first line? | B·g | [linkedin-messaging-guide ch-5](../SOURCES.md#src-linkedin-messaging-guide) |
| GTM-10<a name="gtm-10"></a> | first outbound asks for a meeting | **Soft CTA / foot-in-door**: earn call rights; never cold-Calendly | Have they agreed a conversation exists? | B·g | [linkedin-messaging-guide ch-7](../SOURCES.md#src-linkedin-messaging-guide) + [linkedin-messaging-guide ch-12](../SOURCES.md#src-linkedin-messaging-guide) |
...
| NEG-02<a name="neg-02"></a> | pre-meeting dread / bad-news call | **Surface the harshest true reading first**: name the worst fair charges before the counterpart does, so the rest of the conversation is not spent dodging them | Have I stated the hardest true criticism myself? | S·g | [never-split-the-difference](../SOURCES.md#src-never-split-the-difference) |
...
| NEG-04<a name="neg-04"></a> | early smooth yes | **Test commitment beyond a polite yes**: counterfeit agreement detector; seek an owned restatement of the deal in the counterpart's words, not a single easy affirmation | Can they restate the commitment in their own words? | B·g | [never-split-the-difference](../SOURCES.md#src-never-split-the-difference) |
...
| OPS-02<a name="ops-02"></a> | calendar fills with mediocre initiatives to reduce anxiety | **Sit on your hands**: explicit no-swing criteria; swing only at fat pitches | What is the "no swing" criterion this week? | S·o | [poor-charlies-almanack sec-fat-pitch](../SOURCES.md#src-poor-charlies-almanack) |
