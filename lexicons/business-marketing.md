...
| --- | --- | --- | --- | --- | --- |
| STRAT-01<a name="strat-01"></a> | strategy uses one framework for a multi-causal bet | **Latticework required**: hang the decision on multiple discipline models or refuse certainty | Which three non-native models change the conclusion? | B·s | [poor-charlies-almanack sec-talk-2](../SOURCES.md#src-poor-charlies-almanack) |
| STRAT-02<a name="strat-02"></a> | plan only shows the path to win, no failure anatomy | **Invert, always invert**: define non-X and disconfirmers before the forward plan (↔ ml [[FAIR-02]](ml-systems.md#fair-02)/[[FAIR-03]](ml-systems.md#fair-03) disaggregated evidence before deploy; ↔ ml [[HITL-05]](ml-systems.md#hitl-05) agreement is not truth before the label commits; ↔ ux [[INT-07]](interaction-ux.md#int-07) preview before costly commit; ↔ ml [[EVAL-01]](ml-systems.md#eval-01)/[[TEST-03]](engineering.md#test-03) baseline and characterization before the new contract) | Where do we die, and what evidence would kill this thesis? | B·s | [poor-charlies-almanack sec-talk-1](../SOURCES.md#src-poor-charlies-almanack) |
| STRAT-03<a name="strat-03"></a> | team enters a domain where the edge boundary is unknown | **Circle of competence**: yes / no / too-tough baskets; no fake fluency (↔ epi [[NDM-01]](epistemics.md#ndm-01) trust expertise only when validity and feedback hold; ↔ ux [[HAI-05]](interaction-ux.md#hai-05) do not name capability beyond the tested envelope; ↔ ml [[CAL-02]](ml-systems.md#cal-02) unknown is a valid result; ↔ ml [[EMB-04]](ml-systems.md#emb-04) de-emphasise the identity-void rather than force a face; ↔ ml [[HITL-07]](ml-systems.md#hitl-07) escalate the unsure item to a human) | If the next hard question comes, are we Planck or the chauffeur? | B·s | [poor-charlies-almanack sec-circle-competence-boundaries](../SOURCES.md#src-poor-charlies-almanack) |
| STRAT-04<a name="strat-04"></a> | rare clear edge appears with favorable odds | **Load the boat**: bet seldom, bet big when mispriced; pair with [[OPS-02]](business-marketing.md#ops-02) sit-on-your-hands | If we only get 20 punches lifetime, is this punch-worthy? | S·s | [poor-charlies-almanack sec-talk-2](../SOURCES.md#src-poor-charlies-almanack) |
| STRAT-05<a name="strat-05"></a> | a product bet is justified mainly by a competitor's launch, raise, valuation, executive attention, or peer adoption | **Mediated-desire audit**: separate independently observed customer evidence from desire borrowed from a competitor or status model; imitation makes desire converge on one object without proving it is autonomously valuable to *this* firm (multi-firm "many converge" generalizes the individual case; confidence is higher on the mediated-by-a-rival core) (↔ [[STRAT-16]](business-marketing.md#strat-16) name remote vs same-sphere mediation before acting on the model) | Would we choose this bet if the competitor's activity were hidden? | S·p | [girard-mensonge-romantique ch-1](../SOURCES.md#src-girard-mensonge-romantique) |
| STRAT-06<a name="strat-06"></a> | roadmap fills with consumer conveniences | **Consequential over trivial**: allocate talent to problems that still matter in a decade | If this wins, what capability exists that didn't? | S·s | [technological-republic ch-1](../SOURCES.md#src-technological-republic) |
| STRAT-07<a name="strat-07"></a> | strategy flipped after a pile-on / backlash | **Conviction over crowd veto**: backlash is input, not board | What did we believe last quarter that evidence still supports? | J·s | [technological-republic ch-3](../SOURCES.md#src-technological-republic) |
| STRAT-08<a name="strat-08"></a> | planning a debut mass-market win as if it funds five years | **Spike is not a business model**: extract rights and cash from a spike; don't staff for automatic repeat | What survives if the spike never happens again? | B·s | [klf-the-manual](../SOURCES.md#src-klf-the-manual) |
| STRAT-09<a name="strat-09"></a> | post-hit plan is to rerun the exact exploit | **One-time hole**: systems close visible hacks; change formula or accept nostalgia | What breaks if the platform adapts tomorrow? | S·s | [klf-the-manual](../SOURCES.md#src-klf-the-manual) |
...
| STRAT-18<a name="strat-18"></a> | brand or positioning claims radical originality while the feature or narrative checklist is peer-parity, or the team shows unusually sharp scorn for "copycats" | **Denied imitation**: under same-sphere rivalry the most exact imitation is the most vigorously denied; originality rhetoric plus a peer-parity feature checklist, or scorn for "copycats", is a cue to audit the hidden model, not proof of autonomy (↔ [[STRAT-05]](business-marketing.md#strat-05) mediated desire is not independent evidence; ↔ [[STRAT-16]](business-marketing.md#strat-16) same-sphere mediation is the denial regime) | Who is the model we refuse to name, and what of theirs are we shipping? | J·g | [girard-mensonge-romantique ch-1](../SOURCES.md#src-girard-mensonge-romantique) |
| STRAT-19<a name="strat-19"></a> | artifact labeled strategy lacks diagnosis, guiding policy, or coordinated near actions | **Kernel required**: refuse or rewrite until diagnosis, guiding policy, and coherent action are all present and mutually consistent | What is the challenge, the approach, and the first coordinated moves? | B·s | [good-strategy-bad-strategy ch-5](../SOURCES.md#src-good-strategy-bad-strategy) |
| STRAT-20<a name="strat-20"></a> | plan, roadmap, OKR set, or funding request **not branded as strategy** sets goals or initiatives without naming the central obstacle | **Face the challenge**: define the difficulty and its causes before goals or spend | What obstacle, if removed, would most change outcomes? | B·s | [good-strategy-bad-strategy ch-3](../SOURCES.md#src-good-strategy-bad-strategy) |
| STRAT-21<a name="strat-21"></a> | objective restates the desired end-state at the same difficulty as the original challenge | **No blue-sky objective**: replace with a proximate, competence-feasible target | Can we hit this with resources and skill we actually have? | S·s | [good-strategy-bad-strategy ch-3](../SOURCES.md#src-good-strategy-bad-strategy) + [good-strategy-bad-strategy ch-7](../SOURCES.md#src-good-strategy-bad-strategy) |
| STRAT-22<a name="strat-22"></a> | multi-link system underperforms; spend continues on non-bottleneck links | **Weakest-link first**: identify the limiting link; sequence improvement campaigns; do not strengthen non-bottlenecks alone | What is the current weakest link, and are we funding it first? | S·s | [good-strategy-bad-strategy ch-8](../SOURCES.md#src-good-strategy-bad-strategy) |
| STRAT-23<a name="strat-23"></a> | strategy claims a Power/advantage with cash-flow Benefit or arbitrage Barrier explicit and the other missing | **Benefit-and-Barrier dual test**: refuse Power language until cash-flow Benefit *and* arbitrage Barrier are both explicit; look to Barrier first | What stops a competent rival from arbitraging this advantage? | B·s | [seven-powers](../SOURCES.md#src-seven-powers) |
| STRAT-24<a name="strat-24"></a> | strategy review or plan advances with no named route to continuing differential returns vs a material rival class | **Continuing-advantage route required**: refuse or rewrite until a route to continuing Power vs a named material competitor class is explicit (why the advantage persists); a Power-type label alone does not pass | What route, vs which rival class, keeps the advantage from eroding? | B·s | [seven-powers](../SOURCES.md#src-seven-powers) |
| STRAT-25<a name="strat-25"></a> | unit/line is managed under a shared strategy while Power drivers and rivals are orthogonal | **Strategically separate businesses**: run separate Power routes per orthogonal activity | Are Power drivers and rival sets actually the same? | S·s | [seven-powers](../SOURCES.md#src-seven-powers) |
| STRAT-26<a name="strat-26"></a> | mature category where switching costs are understood and new-customer acquisition competes on transparent price | **Capture before SC arbitrage**: prioritize installed-base capture before pricing arbitrage erases Benefit on new customer acquisitions | Are we still pre-arbitrage on acquisition price, or already in the pricing war? | S·s | [seven-powers ch-4](../SOURCES.md#src-seven-powers) |
| STRAT-27<a name="strat-27"></a> | strategy or market-entry memo claims industry attractiveness from growth, short-run factors, or rival headcount without a written industry-structure diagnosis of entry, rivalry, substitutes, buyer power, and supplier power | **Industry-structure forces first**: refuse attractiveness claims until those five structural forces are analyzed for strength and the strongest force(s) named — profit potential is structural, not transient | Which force most caps returns here, and what evidence establishes its strength? | B·s | [competitive-strategy-porter ch-1](../SOURCES.md#src-competitive-strategy-porter) |
| STRAT-28<a name="strat-28"></a> | competitive move is locked on a feature-matrix or informal "we know them" brief with no stated likely reactions to this move | **Rival reaction before move**: refuse to lock the move until likely rival reactions are written; document goals, current strategy, assumptions, and capabilities as evidence for those reactions | What assumptions would make this rival desperate or indifferent to this move? | S·s | [competitive-strategy-porter ch-3](../SOURCES.md#src-competitive-strategy-porter) |
| STRAT-29<a name="strat-29"></a> | inside an industry, plan is only "gain share" or copy average tactics with no group map | **Strategic-group placement**: place the firm on key strategy dimensions, name mobility barriers for the target group, and check intergroup interdependence before share targets | Which strategic group are we in or entering, and what barriers protect it? | S·s | [competitive-strategy-porter ch-7](../SOURCES.md#src-competitive-strategy-porter) |

<!-- BEGIN GENERATED SECTION SOURCES fam-strat -->

**Sources for this section**

- [competitive-strategy-porter](../SOURCES.md#src-competitive-strategy-porter)
- [four-hour-workweek](../SOURCES.md#src-four-hour-workweek)
- [girard-mensonge-romantique](../SOURCES.md#src-girard-mensonge-romantique)
- [good-strategy-bad-strategy](../SOURCES.md#src-good-strategy-bad-strategy)
...
- [seven-powers](../SOURCES.md#src-seven-powers)
...
| ID | Trigger | Rule | Answers | T·P | Src |
| --- | --- | --- | --- | --- | --- |
| PROD-01<a name="prod-01"></a> | feature request without an outcome metric | **Outcome over output**: ship only what changes valuable behavior (↔ [[OPS-01]](business-marketing.md#ops-01) you get the incentive you pay for, not the outcome you meant; ↔ eng [[TEST-11]](engineering.md#test-11) stability over gameable coverage; ↔ ux [[UXR-03]](interaction-ux.md#uxr-03) a metric that cannot decide the goal is the wrong number; ↔ writ [[WRIT-28]](writing.md#writ-28) prestige proxies are not named effects) | What human behavior must change, by how much? | B·p | [lean-ux ch-3](../SOURCES.md#src-lean-ux) |
| PROD-02<a name="prod-02"></a> | long PRD / solution brief arrives first | **Problem before solution**: restate as a business problem with measurable adverse effect | What adverse effect and behavior define success? | B·s | [lean-ux ch-5](../SOURCES.md#src-lean-ux) |
| PROD-03<a name="prod-03"></a> | expensive feature debate | **Cheapest learning first**: landing page / fake door / Wizard-of-Oz before build | What's the least work to learn the riskiest unknown? | S·p | [lean-ux ch-12](../SOURCES.md#src-lean-ux) |
| PROD-04<a name="prod-04"></a> | experiment fails but the team loves the design | **Falsification wins**: kill or pivot; taste isn't evidence (↔ [[STRAT-02]](business-marketing.md#strat-02) define the disconfirmers before the plan; ↔ eng [[DBG-06]](engineering.md#dbg-06)/[[DBG-11]](engineering.md#dbg-11) a fix is real only when the cause's absence kills the failure; ↔ sec [[SECD-07]](security.md#secd-07) threat-model the ways it dies before buying controls; ↔ epi [[FORE-03]](epistemics.md#fore-03) score the forecast, do not reframe hits) | What result would make us wrong, and did we see it? | B·p | [lean-ux ch-12](../SOURCES.md#src-lean-ux) |
| PROD-05<a name="prod-05"></a> | low evidence, high-fidelity plan | **Truth Curve**: investment proportional to market evidence (↔ ux [[UXR-01]](interaction-ux.md#uxr-01) the method must be able to support the claim's level; ↔ [[STRAT-02]](business-marketing.md#strat-02) evidence before the commitment; ↔ ml [[PROV-02]](ml-systems.md#prov-02) model card before release; ↔ ux [[INT-07]](interaction-ux.md#int-07) preview before the costly commit) | What evidence justifies this fidelity? | S·p | [lean-ux ch-12](../SOURCES.md#src-lean-ux) |
| PROD-06<a name="prod-06"></a> | "we know our users" with no recent contact | **Persona three gates**: exist, need, switch value; recruit to prove | Can we recruit them, confirm the pain, and beat the incumbent? | B·p | [lean-ux ch-7](../SOURCES.md#src-lean-ux) |
| PROD-07<a name="prod-07"></a> | roadmap is a feature timeline | **Outcome roadmap**: leadership sets metrics; the team chooses features | Why this work, and how will we know we did a good job? | B·s | [lean-ux ch-17](../SOURCES.md#src-lean-ux) |
| PROD-08<a name="prod-08"></a> | product designed from taste or golden-age references | **Study the Top, not your era**: current mass winners share more with each other than with their genre roots | What are this month's winners doing that ours refuses to do? | S·p | [klf-the-manual](../SOURCES.md#src-klf-the-manual) |
| PROD-09<a name="prod-09"></a> | feature ignores hard channel constraints (length, hook, review rules) | **Format-first construction**: write the channel contract before the components (↔ [[CLM-05]](business-marketing.md#clm-05) three hostile readers of the claim; ↔ eng [[RLSE-09]](engineering.md#rlse-09) plain-English expert gate; ↔ sec [[SECD-01]](security.md#secd-01) write the policy before the mechanism; ↔ eng [[AGT-08]](engineering.md#agt-08) a guard rejection is the named contract to satisfy) | What will the gatekeeper fade, skip, or demote? | B·p | [klf-the-manual](../SOURCES.md#src-klf-the-manual) |
| PROD-10<a name="prod-10"></a> | team blocked seeking the never-seen | **Recombine proven parts**: assemble from current winners; personality rides the collage | Which past winners can we legally recombine this week? | S·p | [klf-the-manual](../SOURCES.md#src-klf-the-manual) |
| PROD-11<a name="prod-11"></a> | efficiency investment in a commodity-like offer | **Second-step test**: do the savings stick to us or flow to customers? | After competitors copy this tool, who keeps the margin? | S·p | [poor-charlies-almanack sec-talk-2](../SOURCES.md#src-poor-charlies-almanack) |
| PROD-12<a name="prod-12"></a> | builders never meet the operational user on the real workflow | **Builder–user proximity**: continuous first-hand contact with the person who runs the product on their worst day; a requirements doc is not a substitute for getting out of the building (↔ a11y [[A11Y-23]](accessibility.md#a11y-23): the worst-day user includes the AT user) | Would a field user trust this UI on their worst day? | S·p | [technological-republic ch-13](../SOURCES.md#src-technological-republic) |
| PROD-13<a name="prod-13"></a> | "we build because we can" | **What/why before can**: purpose precedes capability demos | Who is harmed if we never ship this, and served if we do? | S·p | [technological-republic ch-6](../SOURCES.md#src-technological-republic) |
...
| AIPX-05<a name="aipx-05"></a> | model path with no fallback | **Heuristic fallback required**: fail closed to a safe deterministic path | What do we show when confidence is low or input is garbage? | B·o | [building-ml-powered-applications ch-10](../SOURCES.md#src-building-ml-powered-applications) |
| AIPX-06<a name="aipx-06"></a> | new model to 100% of traffic | **Shadow then canary**: prove production parity before cutover | Have we compared on live traffic without burning users? | S·o | [building-ml-powered-applications ch-11](../SOURCES.md#src-building-ml-powered-applications) |
| AIPX-07<a name="aipx-07"></a> | advice/description feature tuned for coverage | **Precision-first guidance**: wrong advice costs more than silence (↔ ml [[CAL-02]](ml-systems.md#cal-02) abstention is safer than a forced wrong class; ↔ [[STRAT-03]](business-marketing.md#strat-03) too-tough is a designed basket; ↔ eng [[RLSE-04]](engineering.md#rlse-04) empty/error/offline are designed states) | What happens to trust the first time we're wrong? | S·p | [building-ml-powered-applications ch-7](../SOURCES.md#src-building-ml-powered-applications) |
| AIPX-09<a name="aipx-09"></a> | objective claim drives real action | **Secondary verification for stakes**: high-stakes outputs need a human or external check layer (↔ sec [[SEC-05]](security.md#sec-05) human approves before the side effect executes; ↔ eng [[DATA-18]](engineering.md#data-18) check-then-act under weak isolation is the irreversible side; ↔ a11y [[A11Y-25]](accessibility.md#a11y-25) retrofit costs more than the hedge at write time) | Can a wrong accept cause irreversible harm? | B·p | [designing-ai-interfaces sec-designing-verifiability](../SOURCES.md#src-designing-ai-interfaces) |
| AIPX-10<a name="aipx-10"></a> | request for a model-confidence badge | **No confidence theater**: sources, hedges, and validation paths over self-reported % | Can the user validate without trusting a score? | S·p | [designing-ai-interfaces sec-designing-verifiability](../SOURCES.md#src-designing-ai-interfaces) |
| AIPX-13<a name="aipx-13"></a> | humanlike AI in a commercial surface | **Disclose AI early**: synthetic nature labeled as an understanding aid (↔ ux [[HAI-14]](interaction-ux.md#hai-14) label AI content that could pass as human; ↔ grph [[GRPH-18]](graph-theory.md#grph-18) a named similarity boundary the data never enforced; ↔ sec [[WEB-21]](security.md#web-21) ambient authority the eye never chose; ↔ eng [[NAME-03]](engineering.md#name-03) a name that promises a type the code does not hold) | Could a user reasonably think this is a human? | B·g | [designing-ai-interfaces sec-this-summary-ai-generated](../SOURCES.md#src-designing-ai-interfaces) |
...
| AIPX-16<a name="aipx-16"></a> | multi-step autonomous workflow | **Early draft plan + step control**: show the scaffold early and allow stop, edit, or redirect mid-flight (↔ ux [[HAI-04]](interaction-ux.md#hai-04) activate-operate-override, [[HAI-13]](interaction-ux.md#hai-13) user must detect and steer when the system cannot) | Can the user stop, edit, or redirect mid-flight? | S·p | [designing-ai-interfaces sec-exposing-planning](../SOURCES.md#src-designing-ai-interfaces) |
...
| GTM-06<a name="gtm-06"></a> | heat is high but the ranked/instrumented number is flat | **Resource the ranking nodes**: spend where the number is actually typed, scanned, counted (↔ [[OPS-01]](business-marketing.md#ops-01) pay for the node that records the outcome; ↔ [[PROD-01]](business-marketing.md#prod-01) heat is not valuable behavior change) | Where is the number actually recorded? | B·g | [klf-the-manual](../SOURCES.md#src-klf-the-manual) |
| GTM-07<a name="gtm-07"></a> | mass-market name/title is witty or needs explanation | **Title = emotional first line**: one basic feeling; clever caps at cult | Can a stranger repeat the meaning after one exposure? | S·g | [klf-the-manual](../SOURCES.md#src-klf-the-manual) |
| GTM-08<a name="gtm-08"></a> | debut leads with craft excellence, no novelty package | **Novelty beats craft on first exposure**: strangers can't judge quality yet | What is newsworthy in one scroll? | S·g | [klf-the-manual](../SOURCES.md#src-klf-the-manual) |
| GTM-09<a name="gtm-09"></a> | drafting a LinkedIn (or analogous social) sales message to a prospect | **Research × personalization × relevance**: all three or silence | What is uniquely true about *them* in the first line? | B·g | [linkedin-messaging-guide ch-5](../SOURCES.md#src-linkedin-messaging-guide) |
| GTM-10<a name="gtm-10"></a> | first outbound asks for a meeting | **Soft CTA / foot-in-door**: earn call rights; never cold-Calendly | Have they agreed a conversation exists? | S·g | [linkedin-messaging-guide ch-7](../SOURCES.md#src-linkedin-messaging-guide) + [linkedin-messaging-guide ch-12](../SOURCES.md#src-linkedin-messaging-guide) |
...
| ID | Trigger | Rule | Answers | T·P | Src |
| --- | --- | --- | --- | --- | --- |
| NEG-01<a name="neg-01"></a> | unreasonable demand / hard no on terms | **Return the constraint as a path problem**: invite the demander to propose a workable path that respects the limit, rather than arguing the limit itself | Did I restate the constraint and ask how a workable path would look? | S·g | [never-split-the-difference](../SOURCES.md#src-never-split-the-difference) |
| NEG-02<a name="neg-02"></a> | bad-news call, confrontation, or accusation-audit meeting is scheduled | **Surface the harshest true reading first**: name the worst fair charges before the counterpart does, so the rest of the conversation is not spent dodging them | Have I stated the hardest true criticism myself? | S·g | [never-split-the-difference](../SOURCES.md#src-never-split-the-difference) |
| NEG-03<a name="neg-03"></a> | counterpart emotion spikes | **Label the emotion, then pause**: an accurate neutral label makes the concern discussable without arguing against it | Did I name the feeling and leave space? | S·g | [never-split-the-difference](../SOURCES.md#src-never-split-the-difference) |
| NEG-04<a name="neg-04"></a> | early smooth yes | **Three Yeses test**: get agreement to the same commitment three times — a yes, a "that's right" summary, and a How-implementation question | Which three different affirmations of this commitment do we have? | B·g | [never-split-the-difference ch-8](../SOURCES.md#src-never-split-the-difference) |
| NEG-05<a name="neg-05"></a> | haggle phase opens | **Plan concessions before bargaining**: use diminishing moves toward a precise target, make each concession reciprocal, and keep a nonmonetary option for the end | Are concessions planned, reciprocal, and shrinking? | S·g | [never-split-the-difference](../SOURCES.md#src-never-split-the-difference) |
| NEG-06<a name="neg-06"></a> | only the champion is engaged | **Map offline decision-makers**: absent deal-killers outrank the people in the room | Who outside this room can kill the deal? | B·g | [never-split-the-difference](../SOURCES.md#src-never-split-the-difference) |
| NEG-07<a name="neg-07"></a> | radio silence | **Reopen with a low-cost refusal option**: a brief loss-framed question that permits no can restore autonomy and elicit status without another needy follow-up | Does my reopen make "no" easy and informative? | S·g | [never-split-the-difference](../SOURCES.md#src-never-split-the-difference) |
...
| OPS-10<a name="ops-10"></a> | founder deep in specialist execution while the channel goal drifts | **Steer the goal, not the craft**: specify and accept or reject; do not become the crew | Does this decision still aim at the harbor metric? | S·o | [klf-the-manual](../SOURCES.md#src-klf-the-manual) |
| OPS-11<a name="ops-11"></a> | postmortem stops at "operator error" | **Five Whys into incentives**: chase the structure that made the miss rational | What org/pricing incentive made this rational? | S·o | [technological-republic ch-14](../SOURCES.md#src-technological-republic) |
...
| OPS-18<a name="ops-18"></a> | quality report claims improvement because cost-per-defect dropped while defect volume fell | **Ban cost-per-defect as quality proof**: fixed verification costs make unit cost rise as bugs disappear — use delivered defects per size and defect-removal efficiency (↔ [[OPS-19]](business-marketing.md#ops-19) the pair that replaces it — defect potential and removal efficiency measure the outcome cost-per-defect inverts; ↔ [[OPS-01]](business-marketing.md#ops-01) cost-per-defect is a KPI that pays for keeping defects alive; fix the incentive before trusting the number) | Did delivered defects per size unit fall, or only cost per remaining bug? | S·o | [software-development-patterns-antipatterns ch-5](../SOURCES.md#src-software-development-patterns-antipatterns) |
| OPS-19<a name="ops-19"></a> | quality claim, SLA, or dashboard tracks only code bugs or only test counts — no multi-origin defect potential and no defect-removal efficiency | **Defect potential + DRE pair**: measure bugs from requirements/design/code/docs/bad fixes and the percent removed before release (↔ eng [[RLSE-14]](engineering.md#rlse-14) escapes and DRE are the release-gate form of the same outcome meter; ↔ eng [[TEST-11]](engineering.md#test-11) coverage alone is gameable activity, not removal efficiency; ↔ [[PROD-01]](business-marketing.md#prod-01) test counts are output; defect potential and removal efficiency are the outcome) | What is our defect potential by origin, and what DRE do we claim? | S·o | [software-development-patterns-antipatterns ch-11](../SOURCES.md#src-software-development-patterns-antipatterns) |
| OPS-20<a name="ops-20"></a> | multi-team or multi-quarter effort planned with small-app ceremony only (unit tests, informal estimate, no inspections/static-analysis path) | **Size-risk scaling**: failure odds, activity set, and specialist needs jump with size — scale control with size | What process would we refuse at 10× this size, and why is it fine now? | S·o | [software-development-patterns-antipatterns ch-1](../SOURCES.md#src-software-development-patterns-antipatterns) + [software-development-patterns-antipatterns ch-6](../SOURCES.md#src-software-development-patterns-antipatterns) |
...
| OPS-24<a name="ops-24"></a> | shared upstream sees type-batches or period-end demand spikes | **Level the load**: smooth mix and rate at the final scheduling point so upstream need not hold peak capacity of every variant | Where does the spike enter, and what mixed sequence would flatten it? | S·o | [toyota-production-system ch-2](../SOURCES.md#src-toyota-production-system) |
| OPS-25<a name="ops-25"></a> | problem-response roles (incident lead, andon/offline helper) are loaded with production WIP when quiet | **Protect response capacity**: quiet-time job is last-incident root cause, not fill work that delays the next signal | If the signal fires now, is the responder free to move? | S·o | [management-lessons-taiichi-ohno ch-1](../SOURCES.md#src-management-lessons-taiichi-ohno) |
| OPS-26<a name="ops-26"></a> | short-term plan is rebuilt from scratch after every minor disruption (single rush job, small delay) | **Min-disruption reactive repair**: for minor events prefer local insert/repair that keeps the schedule close to the prior one; full re-hop only when the disruption is major | Will a full rebuild confuse operators more than it gains objective points? | S·o | [pinedo-scheduling ch-18](../SOURCES.md#src-pinedo-scheduling) |
| OPS-27<a name="ops-27"></a> | bottleneck machine planned with empty upstream buffer while upstream can fail or pause | **Bottleneck starvation buffer**: keep a small ready queue in front of the bottleneck so upstream stops do not idle the scarce resource | Is the bottleneck protected by a deliberate ready buffer? | S·o | [pinedo-scheduling ch-18](../SOURCES.md#src-pinedo-scheduling) |
| OPS-28<a name="ops-28"></a> | business case names monetized or strategic benefits that already have operational definitions and resolution criteria, but no post-delivery owner or measurement cadence is assigned before go | **Benefit ownership before go**: assign who measures realized benefits against the forecast and when | Who owns benefit realization metrics after handoff? | S·o | [measure-anything-project-management ch-8](../SOURCES.md#src-measure-anything-project-management) |
| OPS-29<a name="ops-29"></a> | Agile vs committed-plan / waterfall choice is made without comparing rework cost and decision reversibility | **Rework-cost process gate**: prefer short iterative cycles when reversals are cheap enough; prefer committed plans when rework and multi-tier contracts dominate | What does a wrong reversible choice cost versus a wrong locked-in choice? | J·o | [measure-anything-project-management ch-7](../SOURCES.md#src-measure-anything-project-management) |
| OPS-30<a name="ops-30"></a> | cost-benefit model is discarded once the project is approved | **Keep the living project model**: update uncertainties and recompute decisions (continue, re-scope, cancel) through delivery | Where is the current model for the remaining project decisions? | S·o | [measure-anything-project-management ch-4](../SOURCES.md#src-measure-anything-project-management) |
...
- [four-hour-workweek](../SOURCES.md#src-four-hour-workweek)
- [klf-the-manual](../SOURCES.md#src-klf-the-manual)
- [management-lessons-taiichi-ohno](../SOURCES.md#src-management-lessons-taiichi-ohno)
- [measure-anything-project-management](../SOURCES.md#src-measure-anything-project-management)
...
- [technological-republic](../SOURCES.md#src-technological-republic)
- [toyota-production-system](../SOURCES.md#src-toyota-production-system)

<!-- END GENERATED SECTION SOURCES fam-ops -->

## 7. Bootstrap Brand Economics<a name="fam-boot"></a>

> Bibliography: [Berg, *Porn Work*](../SOURCES.md#src-porn-work).

| ID | Trigger | Rule | Answers | T·P | Src |
| --- | --- | --- | --- | --- | --- |
| BOOT-01<a name="boot-01"></a> | zero-capital brand building | **Own before polish**: the first assets are rights, name, and a direct contact path; polish comes after ownership (↔ eng [[REF-15]](engineering.md#ref-15) every hard-coded dependency is a forfeited exit) (↔ [[BOOT-07]](business-marketing.md#boot-07) ownership-before-polish and multi-home-before-you-need-to are one hostile-landlord posture, the residual and the exit) | If the platform dies tomorrow, what residual remains? | B·s | [porn-work sec-short-history](../SOURCES.md#src-porn-work) |
| BOOT-02<a name="boot-02"></a> | work sold once with no rights retained | **Scene-as-ad**: treat each visible unit as promotional labor for owned recurring streams | What owned product does this unit sell? | S·g | [porn-work ch-3](../SOURCES.md#src-porn-work) |
| BOOT-03<a name="boot-03"></a> | partner/platform pushes costs onto the creator | **Turn forced cost into product**: recapture imposed costs as fan-facing offerings under your own name | Does this cost build their equity or ours? | S·o | [porn-work sec-economics-hustle](../SOURCES.md#src-porn-work) |
| BOOT-04<a name="boot-04"></a> | pricing your own labor/service | **Eyes-closed rate floor**: below the feel-good price the asset burns out; resentment compounds | Would I resent this rate after the platform's cut? | B·o | [porn-work sec-money-matters](../SOURCES.md#src-porn-work) |
| BOOT-05<a name="boot-05"></a> | intimacy/access/attention as the product | **Bounded authenticity**: real connection, metered and calendared; the boundary is what makes it sustainable | Where does the performance end on the calendar? | S·o | [porn-work sec-money-matters](../SOURCES.md#src-porn-work) |
| BOOT-06<a name="boot-06"></a> | free samples/tiers offered | **Freemium kill switch**: free exists only with a stated conversion hypothesis | What paid action does this free unit force? | S·g | [porn-work sec-exposure](../SOURCES.md#src-porn-work) |
| BOOT-07<a name="boot-07"></a> | one platform carries the revenue | **Hostile-landlord assumption**: multi-home the masters and the rails before you need to (↔ [[GTM-04]](business-marketing.md#gtm-04) rent muscle under your own label; ↔ sec [[SEC-04]](security.md#sec-04) least-privilege agency so a jailbreak reaches little) | Can a ToS change kill >50% of revenue in a week? | B·s | [porn-work sec-class-politics-censorship](../SOURCES.md#src-porn-work) |
| BOOT-08<a name="boot-08"></a> | follower counts as KPIs | **Payers per 1k followers**: optimize paid conversion, not reach (↔ [[OPS-01]](business-marketing.md#ops-01) the reach number is not the paid outcome; ↔ [[PROD-01]](business-marketing.md#prod-01) payers are the behavior change) | How many payers per thousand? | S·g | [porn-work sec-exposure](../SOURCES.md#src-porn-work) |
| BOOT-09<a name="boot-09"></a> | collab/trade arrangements | **Symmetric residual trade**: refuse partners who keep the files and the larger paid audience | Who owns the files, and whose list grows? | S·g | [porn-work sec-class-politics-hustle](../SOURCES.md#src-porn-work) |
| BOOT-10<a name="boot-10"></a> | always-on hustle as the plan | **Rest as COGS**: recovery is a cost of goods; price and schedule it | Is recovery costed into the rate card? | S·o | [porn-work sec-resting](../SOURCES.md#src-porn-work) |
...
- **Novelty vs precision**: [[GTM-08]](business-marketing.md#gtm-08) (novelty wins first exposure) ↔ [[AIPX-07]](business-marketing.md#aipx-07) (Ameisen: precision-first for advice products). First exposure can be novel; the *output* can never be sloppy in a trust product.
...
- **Novelty vs the regulatory line**: [[GTM-08]](business-marketing.md#gtm-08) (novelty beats craft at first exposure) ↔ [[CLM-02]](business-marketing.md#clm-02) (the cost asymmetry is absolute). The hook can be as loud as the campaign wants; the claim inside it stays on the safe side of the line. The novelty lives in the packaging, not in the claim.
- **Channel contract vs claims review**: [[PROD-09]](business-marketing.md#prod-09) (write the gatekeeper's contract before the components) and [[CLM-05]](business-marketing.md#clm-05) (three hostile readers) are the same move at different stakes: App Store guidelines, FDA wellness lines, and radio-edit rules are all channel contracts read by someone paid to find violations. The same pattern appears in playlist committees and app review.
