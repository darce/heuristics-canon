...
|---|---|---|
| <a name="src-algebraic-graph-theory"></a>`algebraic-graph-theory` | algebraic-graph-theory (no distillation on record; see the UNSOURCED ledger) | 1 |
| <a name="src-algorithm-design-manual"></a>`algorithm-design-manual` | Skiena, Steven S. *The Algorithm Design Manual*. 3rd ed., 2020 | 6 |
| <a name="src-building-knowledge-graphs"></a>`building-knowledge-graphs` | building-knowledge-graphs (no distillation on record; see the UNSOURCED ledger) | 4 |
| <a name="src-graph-classification-and-clustering"></a>`graph-classification-and-clustering` | graph-classification-and-clustering (no distillation on record; see the UNSOURCED ledger) | 1 |
...
| <a name="src-graph-partitioning-and-clustering"></a>`graph-partitioning-and-clustering` | graph-partitioning-and-clustering (no distillation on record; see the UNSOURCED ledger) | 3 |
| <a name="src-graph-theory-with-applications"></a>`graph-theory-with-applications` | graph-theory-with-applications (no distillation on record; see the UNSOURCED ledger) | 4 |
| <a name="src-spectral-clustering-and-biclustering"></a>`spectral-clustering-and-biclustering` | spectral-clustering-and-biclustering (no distillation on record; see the UNSOURCED ledger) | 4 |
