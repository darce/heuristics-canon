...
| <a name="src-refactoring-fowler-beck"></a>`refactoring-fowler-beck` | Fowler, Martin, and Kent Beck. *Refactoring: Improving the Design of Existing Code*. 2nd ed., 2018 | 1 |
| <a name="src-skiena-algorithm-design-manual"></a>`skiena-algorithm-design-manual` | Skiena, Steven S. *The Algorithm Design Manual*. 3rd ed., Springer, 2020. (Extracted PDF is the third edition; 2nd ed. copyright line appears in front matter only.) | 1 |
