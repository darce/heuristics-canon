...
| IDNT-05 | logo brief is "freshen it" with associations intact | **Meaningful change only** — no redraw without a strategic why (↔ eng [[REF-05]](engineering.md) change without a named problem is waste) | What breaks if we leave the mark alone? | B·i | design-indaba-dialogues ch-6 |
