...
| Card | Mechanism |
|---|---|
| [attribute-claims-to-their-bearer](attribute-claims-to-their-bearer.md) | Attribute non-visual claims to artefact, source, or viewer |
...
| [frozen-base-additive-delta](frozen-base-additive-delta.md) | Freeze the shared trunk; train only additive residual |
| [least-privilege-blast-radius](least-privilege-blast-radius.md) | Shrink what one compromise can reach |
| [licence-provenance-is-transitive](licence-provenance-is-transitive.md) | Check transitive licence closure, not one-hop permissiveness |
| [margin-and-design-effect-before-the-run](margin-and-design-effect-before-the-run.md) | Seal margin and size n_eff before the run |
...
| [quantization-delta-on-the-failure-metric](quantization-delta-on-the-failure-metric.md) | Gate precision change on the failure metric that decides adoption |
| [reversible-commitments](reversible-commitments.md) | Cheap reversible choice; underpriced irreversibility |
| [runtime-fork-is-part-of-provenance](runtime-fork-is-part-of-provenance.md) | Treat required runtime fork as production and lineage dependency |
| [second-exit-hostile-landlord](second-exit-hostile-landlord.md) | Second exit before a landlord turns |
| [signal-density-not-length](signal-density-not-length.md) | Score description density, not raw length |
| [step-size-by-feedback](step-size-by-feedback.md) | Plan and rollout step size inside the feedback loop |
| [synthetic-artifact-control-arm](synthetic-artifact-control-arm.md) | Control for compositing signature before claiming occlusion competence |
